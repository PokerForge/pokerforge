...
> it — in particular the liability limits, refund/warranty language, and
...
## 3. Your responsibility to check your poker site's rules
...
- Statistical definitions vary between trackers, and a number that looks
  "wrong" compared to another tool may simply be defined differently
- The App is provided for informational and self-study purposes only, and
  should not be your sole basis for any financial decision
...
liability caps varies significantly by jurisdiction.]
